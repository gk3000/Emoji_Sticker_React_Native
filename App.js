...
import {StyleSheet, View, Safe} from 'react-native'
...
// defining routes with components to be rendered
  const MusicRoute = () => <View style={styles.container}><Text>Music</Text></View>;
  const AlbumsRoute = () => <View style={styles.container}><Text>Albums</Text></View>;
  const RecentsRoute = () => <View style={styles.container}><Text>Recents</Text></View>;
// imported one
